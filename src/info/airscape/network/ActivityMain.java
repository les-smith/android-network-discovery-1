...
import info.airscape.network.Utils.Db;
import info.airscape.network.Utils.DbUpdate;
...
final public class ActivityMain extends Activity {
    ...
    public static final String PKG = "info.airscape.network";
    ...
    private void startDiscoverActivity(final Context ctxt) {
    	  ...
    	  Intent intentDiscover = new Intent(ctxt, ActivityDiscovery.class);
