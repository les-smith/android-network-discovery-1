...
import info.airscape.network.ActivityMain;
import info.airscape.network.R;
import info.airscape.network.Network.DownloadFile;
...
public class UpdateNicDb extends AsyncTask<Void, String, Void> {
    ...
    private final static String DB_REMOTE = "http://download.airscape.info/nic.db.gz";
